...
static void
STDCALL
fn_404b68(int a0, int a1, int a2, int a3)
{
    STUB();
    return;
}
...
static void
CDECL
fn_4054a3(const palette_entry_t * palette, int32_t index, int32_t count)
{
...
static uint32_t
CDECL
fn_FileSeekSet(FILE *a0, int32_t distance)
{
...
static uint32_t
CDECL
fn_FileSeekFromCurrent(FILE *a0, int32_t distance)
{
    console::log("seek %d bytes from current", distance);
